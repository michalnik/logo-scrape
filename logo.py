...
from InquirerPy.validator import EmptyInputValidator, Validator, ValidationError
    ...
    def validate(self, document):
        ...
        if not all([parsed.scheme, parsed.netloc]):
            raise ValidationError(
                message='Invalid URL, it must have format http(s)://... ',
...
questions = [
    {
        'type': 'input',
        'name': 'url',
        'message': 'Enter company page URL:',
...
def get_logo(url: str, selector: str, size: (int, int)) -> Image:
